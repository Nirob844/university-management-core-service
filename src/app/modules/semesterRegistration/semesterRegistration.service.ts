...
const getMySemesterRegCorses = async (authUserId: string) => {
  ...
  console.log('semester regis', semesterRegistration);
  ...
  console.log('offer', offeredCourse);
